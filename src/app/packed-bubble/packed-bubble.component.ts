...
pointValue:any;
  ...
  constructor(private sharedDaraService: BubbleAreaService) {
    ...
    this.sharedDaraService.getSelection().subscribe(message => {
			// console.log('hdhd',message.data.area);
      this.areaName=message.data2.area;
      this.plotChart();
			})
...
//   console.log(this.options.series[1].data[1]);
  console.log(this.options.series);
  
  let i=0;
this.options.series.forEach((item:any)=>{
        //  console.log(item);
    let j=0;
    item.data.forEach((item2:any)=>{
        ...
        if(item2.name==this.areaName){
            // console.log(item2.name);
            // item2.color='red';
       
            console.log(this.pointValue.series[i].data[j]);
//             this.options.series[i].data[j].select(false,false);
//   this.options.series[i].data[j].select(true,true);
//------------------OR---------------
